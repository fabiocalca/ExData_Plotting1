...
# Set parameter to put 4 graphs together
par(mfcol=c(2,2))

# Create the first plot as in plot2
with(data,plot(datetime,Global_active_power,type='l',xlab='',ylab='Global Active Power (kilowatts)'))

# Create the second plot as in plot3, but without the legend box line
...
# Create the third plot (Voltage VS datetime)
